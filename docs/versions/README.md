...
| V2.0.2 | 工程基线与旧迁移契约退出 | [PLAN](./v2.0.2/PLAN.md) | [RESULT](./v2.0.2/RESULT.md) | PLAN 已批准；待开发 |

## 当前活动版本

V2.0.2 是当前活动版本，[PLAN](./v2.0.2/PLAN.md) 已根据 `v2.0.1` 只读扫描形成并获用户批准，当前等待开发 Agent 建立候选并实施。项目当前不区分普通用户和开发者界面；V2.1.0 将保留 React + TypeScript + Vite，并完全重构现有页面、交互流程、组件和视觉表现，具体范围仍需另立版本文档。其他 V2 需求继续从需求池选择。
