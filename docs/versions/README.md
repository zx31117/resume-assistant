...
当前活动版本为 [V2.0.0 PLAN](./v2.0.0/PLAN.md)：把 V1.5.0 已验收能力做成本地全流程图形交互首版。已有开发实现与自测记录，当前仍在返工并等待重新冻结候选及独立源码验收；当前实现事实仍以 V1.5.0 为准。

| 版本 | 定位 | 计划 | 结果 | 状态 |
|---|---|---|---|---|
| V2.0.0 | 本地全流程图形交互首版 | [PLAN](./v2.0.0/PLAN.md) | [RESULT](./v2.0.0/RESULT.md) | 开发返工中；待重新冻结候选与独立源码验收 |
