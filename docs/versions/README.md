...
| 版本 | 定位 | 计划 | 状态 |
|---|---|---|---|
| V1.5.0 | 事实级内容决策、两层选材与 SQLite 持久化收束 | [PLAN](./v1.5.0/PLAN.md) | 2026-08-23 已批准执行；从执行时最新 `origin/main` 建立开发基线 |

## 远期草稿（非开发指令）

| 版本 | 定位 | 草稿 | 状态 |
|---|---|---|---|
| V2.0.0 | 用户主页、个人履历库与模型管理后台 | [DRAFT](./v2.0.0/DRAFT.md) | 后续草稿；承接 V1.5.0 Fact/选材前置，并负责模型管理 |
