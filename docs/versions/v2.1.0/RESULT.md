...
## 41. H7 ����ʵʩ��2026-09-08/09�������࣬H7-SRC f249eacd / H7-DEV �����ᣩ

> �����ָ�������current �� 52ef4742/0700a73 ���� parent �¶��ύ��PLAN Ϊ�ɰ桢
> Դ����� H3/db3e407 ���� types.ts �ȵ��ˣ���������Ϊ H7 ���պ�ѡ��
> ���δ���Ч���ջ��� db3e407��canonical �� H6 ��Ʒ�ֽڣ������� H3 5ea56c4������
> �ɾ� worktree���ط� H6 ��46 runner ��� + H7 R32-R34 Դ���޸ģ������� RESULT �ĵ�����
> �γ� H7-SRC���� H7-DEV ���� RESULT���н�����ʵʩ��¼��

### 41.1 ��ѡ����
- H7-SRC = `f249eacd4c54c6e3b99871ea2b8477fdf370e8d1`��parent = db3e407�������� H3 5ea56c4��
- ������ clean����֧ `version/v2.1.0-h7`��current �е� h7-clean ref ͬ��ָ�� f249eacd��
- PLAN.md �ָ�Ϊ��׼ blob `c71ddbae`��H7 �������ȼ������棩��RESULT.md ���� H7-DEV �Ķ�
- H7-DEV = ���� H7-SRC �ĵ����ύ������� docs/versions/v2.1.0/RESULT.md

### 41.2 ʵ��ȫ�ֱ仯��H7-SRC ����8 ���ļ���+943/-15 �У�
| ά�� | �仯 |
|---|---|
| API | `backend/api/routes/template.py` ��� `_serve_template_file`����ʽ `HEAD /api/template/download`��GET/HEAD ����·��У���� FileResponse��H7 R34�� |
| ģ��ְ�� | `backend/services/pdf_renderer.py` `_emit` R33 rev2����һ�ı����� fill+stroke��text render mode 2�����߿����ֺű��� `clamp(size*0.030, 0.2, 0.45)`pt��10.6pt��0.32pt����stroke ɫͬ fill ɫ |
| ǰ�� | `global.css` `.result-export-card` �� `left: calc(var(--sidebar-w) + var(--s5))` ��Ϊ `right: var(--s6)`��խ���۵�Ϊ����������H7 R32�� |
| ǰ�� | `GeneratePage.tsx` `probePdfDownload` ���� `method:'GET', headers:{Range:'bytes=0-0', Accept:'application/pdf'}`������ 200/206 Ϊ�ɴH7 R34�� |
| ���� | `scripts/h6_browser_matrix.py` ��46 ������ + manual��`scripts/precheck.py` ǰ����ʽ����ǰ PowerShell Ԥ�� dist �ƿ� Windows WorkBuddy sandbox node safe-delete shim |
| �����ʲ� | `scripts/h6_browser_matrix.md` runner �����ֲ� |
| �ĵ� | `docs/versions/v2.1.0/PLAN.md` �ָ�Ϊ��׼ blob `c71ddbae` |
| ���� / ���� / ��� spec | �ޱ仯��PyInstaller onedir spec ���� db3e407 ���� |

### 41.3 ��֤�������࣬������
- py_compile��runner/precheck/pdf_renderer/template.py ȫ�� exit 0
- ȷ���Ծ���`backend/_v21_h6_matrix.py` PASS=62 FAIL=0 exit 0
- R9/R15a ����һ���ԣ��״��ܣ���rev1 ˫д���崥�� 9 �� FAIL������/�½�˳��/�����ı��Բ��ϣ�����Ϊ rev2 fill+stroke ���ı������ PASS=54 FAIL=0 exit 0
- R33 ʵ���Ӿ����գ��� `validation-artifacts/h7/r33_visual/`��gitignored��
  - ��Ƭռλ�򼸺Σ�ģ�� docx wp:extent/positionH/V �� pdf_renderer PHOTO_* �������� 0.00cm ƫ��ݲ� 0.08cm��ȫ�� OK��
  - PDF �ı���ȡ������ "����ܿ" ���� 1 �Σ�rev1 ���� 2 �Σ�����ְ������������ҳ
  - դ��֤�ݣ�renderer 150dpi page1 �� Word COM ���� 150dpi page1 ͬ 1241��1754px��top band ƴ�ӶԱȲ���һ��
  - �����ü���renderer 100% / 150% ��������Ϊ `renderer_top_{100,150}pct.png`
- precheck��������Ͻű� + ǰ�˹��� + Hooks �Ž� + F3 sentinel һ�� �� ��ϼ��ȫ��ͨ�� exit 0
- H6 runner dev ��������󣨷��� A������ִ̨���У�uCAUWa������ 25 ���� timeout ���
- H7 onedir �ؽ���PyInstaller 6.22.2������ִ̨���У�mEWhsU��������·�� `packaging/dist/ResumeAssistant/`

### 41.4 R33 rev2 �ؼ����ߣ��� rev1 �Աȣ�
- rev1���ѷ�������ͬλ�ص������Σ�offset 0.025*size�������� R15a 0.6pt ������ 10.6pt CJK
  ��˫�����ճ��/�쳣�ֺڣ���ͬһ������ PDF �������������� �� �ı���ȡ/��ѡ������Ⱦ��
  R9 ����һ�����Ž� FAIL������/�½�/���ܶԲ��ϣ���
- rev2�����ã�����һ�ı����� fill+stroke��text render mode 2�����ı�����ȡ/��ѡ���߿�
  ���ֺű��� `max(0.20, min(0.45, size*0.030))` ��խ���� 10.6pt ��Ϊ 0.32pt��ռ�ֺ� 3%����
  ������ R15a 0.6pt �����Ҳ���� rev1 ˫�������⡣R9 gate PASS=54/54��PDF ����դ��
  �Ӿ���������Ӱ��

### 41.5 ��������һ��
- H7-SRC `f249eacd` ���᣺parent = db3e407��8 �ļ� +943/-15����֧ ref ��ͬ��
- �����������̣��ĵ� Agent �˶� commit/PLAN blob/RESULT ���ݺ��ƶ� review������ Acceptance Agent
  �� ��18.3 + ��18.4 ���ܣ�H6 ���� dev/prod-all ���� + onedir ��ʵʹ�ã���Product Owner ����� T12
- ƫ�H6 ��������󱾻������� agent-browser CLI ���Ự���������� ��45 ����������ʵ��¼����
  R33 ֤���Ѻ� 1 �Ŷ���ƴ�� PNG + 2 �Ŷ����ü� PNG + 1 �� metrics.json��gitignored��
