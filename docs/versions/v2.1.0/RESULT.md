...
> **V2.1.0 首次发布已撤回，正在修正后重发**。功能验收结论保持通过；原 annotated tag
> `v2.1.0` 已从 GitHub 和本地删除，待预检标题修正及新一轮本地/远端门禁通过后重新创建。
> 当前产品基线：已发布 V2.0.2
...
> 发布状态：撤回重发中；原 tag 目标 `8c7bae3746083962b5896519c7f78c82ddaa6548` 保留在 main 历史与本地 backup ref
